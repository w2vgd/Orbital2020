//
//  MSUserReportExpertViewController.swift
//  LinkUs
//
...
class MSUserReportExpertViewController: UIViewController {
    ...
    @IBAction func reportButtonTapped(_ sender: Any) {
        ...
        let data: [String : Any] = [
            ...
            "reportedUserUid" : self.applicationClicked!.matchedExpertUid!,
            "timestamp" : Timestamp()
        ]
...
extension MSUserReportExpertViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "userReportExpertCell", for: indexPath)
...
extension MSUserReportExpertViewController: UITextViewDelegate {
